    ...
    <div class="flex ">
        ...
        <div id="sidebar"
            ...
            <div class="flex items-center justify-center py-2 -mb-10">
                <img src="<?php echo e(asset('images/Ryzuru_store_logo.png')); ?>" alt="Logo" class="w-24 h-24">
...
<?php /**PATH C:\xampp\htdocs\toko_figure\toko_figure\resources\views/layouts/app.blade.php ENDPATH**/ ?>