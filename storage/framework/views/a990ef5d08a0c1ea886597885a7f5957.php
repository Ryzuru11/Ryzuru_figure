<?php $__env->startSection('content'); ?>
    <div class="flex flex-col w-full max-h-screen overflow-y-auto ">
        ...
        <div class="flex items-center justify-around w-full mt-2 lg:justify-between">
            <span class="text-3xl font-semibold ml-5 text-[#9a031f] lg:font-bold lg:text-4xl">Banner</span>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="transition duration-300 border-b bg-gray-50 hover:bg-blue-100">
                                ...
                                <td class="px-4 py-2 text-xs sm:px-6 sm:py-4 sm:text-sm md:text-base">
                                    <img src="<?php echo e(asset('images/banners/' . $banner->photopath)); ?>" alt="<?php echo e($banner->name); ?>"
                                ...
                                <td class="px-4 py-2">
                                    <div class="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2">
                                        ...
                                        <a class="w-full px-4 py-2 text-xs font-bold text-white bg-[#9a031f] rounded cursor-pointer sm:w-auto sm:text-sm md:text-base lg:text-sm"
                                            onclick="showpopup(<?php echo e($banner->id); ?>)">Delete</a>
                                    </div>
                                </td>
                            </tr>
        ...
        <div class="fixed inset-0 items-center justify-center hidden bg-gray-600 bg-opacity-50 backdrop-blur-sm"
            ...
            <form action="<?php echo e(route('banner.destroy', $banner->id)); ?>"
                ...
                <h1 class="mb-4 text-2xl font-semibold text-gray-800">Konfirmasi Penghapusan</h1>
                <p class="mb-6 text-gray-600">Apakah kamu yakin ingin menghapus kategori ini? <br> <span
                        class="text-red-500">Tindakan ini tidak dapat di batalkan.</span></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko_figure\toko_figure\resources\views/banner/index.blade.php ENDPATH**/ ?>