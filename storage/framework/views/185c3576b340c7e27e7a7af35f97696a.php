                            ...
                            <tr class="border-b hover:bg-gray-100">
                                ...
                                <td class="p-2">
                                    <a class="px-3 py-1 text-white bg-[#9a031fdd] rounded cursor-pointer"
                                        onclick="showPopup('<?php echo e($order->id); ?>')">Batalkan</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko_figure\toko_figure\resources\views/myorder.blade.php ENDPATH**/ ?>