<?php $__env->startSection('content'); ?>
    <div class="flex flex-col w-full max-h-screen overflow-y-auto">
        <div class="flex items-center justify-around w-full mt-2 lg:justify-between">
            <span class="text-3xl font-semibold ml-5 text-[#9a031f] lg:font-bold lg:text-4xl">kategori</span>
        </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Category Name Input -->
                <label for="name" class="block text-sm font-medium text-gray-700">kategori nama</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko_figure\toko_figure\resources\views/category/edit.blade.php ENDPATH**/ ?>