...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('images/Ryzuru_store_logo.png')); ?>" type="image/png">
    <style>
        * {
            padding: 0;
            margin: 0;
    ...
    <header class="sticky top-0 z-50 w-full bg-white shadow-md">
        <div class="flex items-center justify-between w-full px-4 mx-auto max-w-7xl">
            ...
            <a class="text-3xl font-bold text-orange-500" href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('images/Ryzuru_store_logo.png')); ?>" alt="Ryzuruicon" class="h-12 lg:h-16">
            </a>
    ...
    <footer class="px-8 py-8 bg-[#9a031fdd] text-white mt-10">
        <div class="max-w-screen-xl mx-auto">
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
                ...
                <div class="-ml-0 lg:-ml-10">
                    <a href="#" aria-label="Kiddo Bazzar Home">
                        <img src="<?php echo e(asset('images/Ryzuru_store_logo.png')); ?>" alt="Ryzurustorelogo"
            ...
            <div class="flex flex-col items-center justify-between md:flex-row">
                ...
                😎<?php echo e(date('Y')); ?> Ryzuru Store. All rights reserved. | Developed by:
...
<?php /**PATH C:\xampp\htdocs\toko_figure\toko_figure\resources\views/layouts/master.blade.php ENDPATH**/ ?>