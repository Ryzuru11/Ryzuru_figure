<?php $__env->startSection('content'); ?>
    ...
    <div class="relative w-full h-64 md:h-96 lg:h-[620px] mb-8">
        <!-- Background Image -->
        <img src="<?php echo e(asset('images/banners/bannerryzu.png')); ?>" alt="Welcome Banner" 
    ...
    <div class="relative w-full h-64 md:h-96 lg:h-[900px]">
        <img src="<?php echo e(asset('images/banners/Sambut-dua-karakter-baru-kolaborasi-figure-fantasy-x-anime-tenshura-ID-banner.jpg')); ?>" alt="Sale Banner" class="object-cover w-full h-full">
                ...
                <a href="<?php echo e(route('viewproduct', $product->id)); ?>" class="flex-shrink-0 lg:col-span-1">
                    ...
                    <div class="overflow-hidden mt-2 border rounded-lg shadow-lg min-w-[16rem] max-w-[18rem]">
                        ...
                        <div class="p-4">
                            ...
                            <p class="text-sm text-gray-500"><?php echo e(Str::limit($product->description, 20)); ?></p>
                            <div class="mt-2">
                                <span class="text-lg font-bold text-gray-900">Rp. <?php echo e($product->price); ?></span>
                                <?php if($product->discounted_price): ?>
    ...
    <div class="relative  mt-2 w-full h-64 md:h-96 lg:h-[500px]">
        <img src="<?php echo e(asset('images/banners/Website-banner_anime.webp')); ?>" alt="Sale Banner" class="object-cover w-full h-full">
    ...
    <div class="relative w-full h-64 md:h-96 lg:h-[500px]">
        <img src="<?php echo e(asset('images/banners/Website-banner_figures.webp')); ?>" alt="Sale Banner" class="object-cover w-full h-full">
        <div class="absolute inset-0 opacity-80 bg-gradient-to-t from-black via-transparent"></div>
        <div class="absolute inset-0 flex flex-col items-center justify-center px-4 text-center text-white">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko_figure\toko_figure\resources\views/welcome.blade.php ENDPATH**/ ?>