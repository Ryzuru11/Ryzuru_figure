<?php $__env->startSection('content'); ?>
    <div class="w-full max-w-2xl p-8 mx-auto bg-white rounded-lg shadow-lg">
        ...
        <div class="flex justify-center mb-6">
            <img src="<?php echo e(asset('images/Ryzuru_store_logo.png')); ?>" alt="Ryzuru" class="object-contain w-20 h-20">
        </div>
...
<?php endif; ?>
        ...
        <p class="mt-4 text-center text-yellow-500">Sudah memiliki akun?
            <a href="<?php echo e(route('login')); ?>" class="text-[#051923] hover:underline">Login disini</a>
        </p>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko_figure\toko_figure\resources\views/auth/register.blade.php ENDPATH**/ ?>